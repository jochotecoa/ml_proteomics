...
echo $tissue
compound=Acetaminophen # "Epirubicin"
compid=APA # "Epi"  ## The abbreviated form of the compound name to write on all output names
if [ $3 = "CONTROL" ]; then
...
compoundfolder="/share/data/hecatos/juantxo/${tissue}/${compound}"
